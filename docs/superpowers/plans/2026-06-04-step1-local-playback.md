...
- [ ] **Step 2: AVPlayerAudioEngine を作成**
...
- [ ] **Step 3: FakeAudioEngine（テスト用）を作成**
...
- [ ] **Step 3: handlePlaybackEnded を実装**
